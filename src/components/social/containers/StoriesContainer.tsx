...
import { 
  Camera, Plus, Clock, Eye, ChevronLeft, FlipHorizontal, 
  Lock, Flame, Loader2
} from "lucide-react";
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="px-4 mb-4">
        ...
        >
          ...
          <span className="text-foreground font-medium">
            {mode === 'gallery' ? 'Capture Moment' : 'Open Camera'}
          </span>
        </button>
      </div>

      {/* Section Switcher (for gallery mode with vault) */}
      {showVault && (
      ...
      <AnimatePresence mode="wait">
        {(!showVault || activeSection === "stories") ? (
          <motion.div
            key="stories"
          ...
          >
            ...
            {/* Recent Stories/Memories */}
            <div className="px-4">
              <div className="flex items-center justify-between mb-3">
                <h3 className="font-medium text-foreground text-sm">
                  {mode === 'memories' ? 'Recent Memories' : 'Recent'}
                </h3>
              ...
              {isLoading ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-muted-foreground">No {mode === 'memories' ? 'memories' : 'stories'} yet</p>
      ...
      <p className="text-[10px] text-muted-foreground text-center mt-6 px-4">
        {mode === 'gallery' ? 'One-time views • AR filters • Private streaks' : 'Status uploads up to 1GB'}
      </p>
